namespace Identity.WebApi.Services
{
    ...
    public class UserService : IUserService
    {
        ...
        {
            new User { UserId = 1, FullName = "test1", Username = "test1", Password = "test@123" },
            new User { UserId = 2, FullName = "test2", Username = "test2", Password = "pass@123" },
            new User { UserId = 3, FullName = "test3", Username = "test3", Password = "admin@123" },
        };
